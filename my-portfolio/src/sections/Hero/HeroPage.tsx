  ...
  return (
    ...
    >
      <div className="content-hero-section" ref={heroRef}>
        <div
          className="container d-flex align-items-center row mb-5"
        ...
        >
          ...
          >
            ...
            <h1 className="fs-1" style={{ color: themeColors.green }}>
              Rumar Pamparo
            </h1>
            ...
            <motion.p
              ...
              transition={{ delay: 0.5, duration: 1 }}
            >
              A fresh graduate and <b>Fullstack Web Developer</b> based in the
              Philippines. I have a passion for building web applications,
              freelancing, and solving complex problems as I grow in my career.
            </motion.p>
